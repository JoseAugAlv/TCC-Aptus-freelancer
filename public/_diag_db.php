<?php
// public/_diag_db.php
// ACESSO: http://localhost/Aptus/_diag_db.php
...
echo '<pre style="font-family:monospace;background:#0f172a;color:#e2e8f0;padding:20px;font-size:14px;line-height:1.6;">';
