-- ============================================================================
-- APTUS — Seed de dados simulados
-- Senha de todos: Aptus@2026
-- Importe DEPOIS do aptus_bd.sql
-- ============================================================================
...
(8, 'Adobe Photoshop'), (8, 'Adobe Illustrator'), (8, 'Adobe InDesign'),
(8, 'Identidade Visual'), (8, 'Social Media Design'), (8, 'Design de E-books'),
(8, 'Criação de Logotipos');

INSERT INTO habilidade (id_categoria, nome) VALUES
(9, 'PHP'), (9, 'JavaScript'), (9, 'React'), (9, 'Node.js'),
(9, 'HTML/CSS'), (9, 'MySQL'), (9, 'React Native'), (9, 'APIs RESTful');

INSERT INTO habilidade (id_categoria, nome) VALUES
(10, 'Fotografia de Produto'), (10, 'Fotografia de Casamento'),
(10, 'Edição de Imagens'), (10, 'Iluminação'),
(10, 'Fotografia de Retratos'), (10, 'Fotografia de Eventos');

INSERT INTO habilidade (id_categoria, nome) VALUES
(11, 'Português-Inglês'), (11, 'Inglês-Português'), (11, 'Espanhol-Português'),
(11, 'Tradução Juramentada'), (11, 'Interpretação Simultânea');

INSERT INTO habilidade (id_categoria, nome) VALUES
(12, 'Marketing Digital'), (12, 'Gestão de Projetos'), (12, 'Análise de Dados'),
(12, 'Growth Hacking'), (12, 'Planejamento Estratégico');

INSERT INTO habilidade (id_categoria, nome) VALUES
(1, 'Instalação Elétrica'), (1, 'Manutenção Elétrica'), (1, 'Automação Residencial');

INSERT INTO habilidade (id_categoria, nome) VALUES
(2, 'Desentupimento'), (2, 'Instalação Hidráulica'), (2, 'Reparo de Vazamentos');

INSERT INTO habilidade (id_categoria, nome) VALUES
(3, 'Limpeza Pesada'), (3, 'Organização de Ambientes'), (3, 'Higienização');

INSERT INTO habilidade (id_categoria, nome) VALUES
(4, 'Construção'), (4, 'Reformas'), (4, 'Acabamentos');

INSERT INTO habilidade (id_categoria, nome) VALUES
(5, 'Pintura Interna'), (5, 'Pintura Externa');

INSERT INTO habilidade (id_categoria, nome) VALUES
(6, 'Jardinagem'), (6, 'Paisagismo'), (6, 'Poda de Árvores');

INSERT INTO habilidade (id_categoria, nome) VALUES
(7, 'Cuidados com Idosos'), (7, 'Cuidados com Crianças'), (7, 'Acompanhamento Médico');
...
-- ============================================================================
-- 19. ATUALIZAÇÃO DAS NOTAS MÉDIAS
-- ============================================================================
