...
$router->post('/perfil/portfolio/excluir', 'PortfolioController@excluir', [3, 2, 1, 4]);
...
/* Exclusão via POST (era GET) */
$router->post('/anuncios/excluir', 'AnuncioController@excluir', [3, 2, 1, 4]);
...
$router->post('/admin/usuarios/excluir', 'AdminUsuarioController@excluir', [1, 4]);
...
$router->post('/admin/categorias/excluir', 'AdminCategoriaController@excluir', [1, 4]);
