...
<div class="disputa-detalhes-container">
    ...
    <div class="disputa-detalhes-card">
        ...
        <div class="disputa-detalhes-servico">
            <h3>Serviço</h3>
            <p><strong>Título:</strong> <?= htmlspecialchars($disputa['anuncio_titulo'] ?? 'N/A') ?></p>
        ...
        <div class="disputa-detalhes-descricao">
            ...
            <p><?= nl2br(htmlspecialchars($disputa['descricao'] ?? 'Não informado')) ?></p>
        </div>
        ...
        <?php if (!empty($disputa['responsavel_nome'])): ?>
            <div class="disputa-detalhes-moderador">
                <p><strong>Analisado por:</strong> <?= htmlspecialchars($disputa['responsavel_nome']) ?></p>
                <p><strong>Data de Resolução:</strong> <?= date('d/m/Y H:i', strtotime($disputa['data_resolucao'] ?? 'now')) ?></p>
            </div>
        <?php endif; ?>
