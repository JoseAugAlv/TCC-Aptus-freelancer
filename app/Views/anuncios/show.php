...
$tituloPagina = $tituloPagina ?? 'Detalhes do Serviço - Aptus';
...
<div class="detalhes-container">
    ...
    <div class="detalhes-info">
        ...
        <div class="avaliacao-detalhes">
            ...
            <span class="total-avaliacoes">(<?= $anuncio['total_avaliacoes'] ?? 0 ?> avaliações)</span>
        </div>
        ...
        <div class="info-extra">
            <span><i class="fas fa-eye"></i> <?= $anuncio['visualizacoes'] ?? 0 ?> visualizações</span>
            <span><i class="fas fa-heart"></i> <?= $anuncio['total_favoritos'] ?? 0 ?> favoritos</span>
        ...
        <div class="freelancer-card">
            <div class="freelancer-header">
                ...
                <div class="freelancer-info">
                    ...
                    <p>
                        ...
                        (<?= $anuncio['total_avaliacoes'] ?? 0 ?> avaliações)
                    </p>
            ...
            <div class="freelancer-stats">
                <div class="stat-item">
                    <div class="stat-valor"><?= $anuncio['quantidade_servicos'] ?? 0 ?></div>
                    <div class="stat-label">Serviços</div>
                </div>
                <div class="stat-item">
                    <div class="stat-valor"><?= number_format($anuncio['nota_media'] ?? 0, 1) ?></div>
        ...
        <div class="detalhes-acoes">
            <?php if ($usuario && $usuario['id'] != $anuncio['id_usuario']): ?>
                ...
                <?php else: ?>
                    <form method="POST" action="/Aptus/interesses/criar?anuncio=<?= $anuncio['id_anuncio'] ?>" 
                          id="formInteresse">
                        <input type="hidden" name="mensagem" value="Olá! Tenho interesse no seu serviço.">
            ...
            <?php elseif (!$usuario): ?>
                <a href="/Aptus/login" class="btn-interesse">
                    <i class="fas fa-sign-in-alt"></i> Faça login para ter interesse
                </a>
            <?php endif; ?>
...
<p><a href="/Aptus/anuncios"><i class="fas fa-arrow-left"></i> Voltar para Serviços</a></p>
